                        ...
                        <div className="form-inline">
                            <div className="form-group">
                                <select className="form-control">
                                    <option value="orderNumber">Search by order number</option>
                                </select>
                            </div>
                            <div className="form-group">
                                <input type="text" className="form-control" placeholder="Order number" onChange={this.onOederNumberChange}/>
                            </div>
                            ...
                            <tbody>
                                {
                                    ...
                                    (
                                        <tr>
                                            <td colSpan="6" className="text-center">Did not find the corresponding result ~</td>
                                        </tr>
                                    )
                                }
