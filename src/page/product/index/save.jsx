...
const ProductSave = React.createClass({
    ...
    render() {
        return (
            <div id="page-wrapper">
                <PageTitle pageTitle={'Commodity management -- ' + (this.state.id ? 'Modify the product' : 'Adding product')}/>
                <div className="row">
                    <div className="form-wrap col-lg-12">
                        <div className="form-horizontal">
                            ...
                            <div className="form-group">
                                <label htmlFor="subtitle" className="col-md-2 control-label">Product description</label>
                                <div className="col-md-5">
                                    <input type="text"
                                        className="form-control"
                                        name="subtitle"
                            ...
                            <div className="form-group">
                                ...
                                <div className="col-md-10">
                                    <select type="password" className="form-control cate-select col-md-5" value={this.state.firstCategoryId} onChange={this.onFirstCategoryChange}>
                                        <option value="">Select the first category</option>
                                        {
                            ...
                            <div className="form-group">
                                <label htmlFor="price" className="col-md-2 control-label">Product prices</label>
                            ...
                            <div className="form-group">
                                <label htmlFor="stock" className="col-md-2 control-label">Product stocks</label>
                                <div className="col-md-3">
                                    <div className="input-group">
                                        <input type="number" 
                                            className="form-control" 
                            ...
                            <div className="form-group">
                                <label htmlFor="inputEmail3" className="col-md-2 control-label">Product images</label>
                                <div className="img-con col-md-10">
                                    {
                                        ...
                                        }) : <div className="notice">Please upload images</div>
                                    }
                                </div>
                            ...
                            <div className="form-group">
                                <label htmlFor="inputEmail3" className="col-md-2 control-label">Product details</label>
                                <div className="col-md-10">
                                    <RichEditor ref="rich-editor" onValueChange={this.onRichValueChange} placeholder="Product details"/>
                                </div>
                            </div>
                            <div className="form-group">
                                <div className="col-md-offset-2 col-md-10">
