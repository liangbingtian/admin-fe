...
import SaleList             from 'page/sale/index/index.jsx';
import IncomeTrend          from 'page/sale/income/index.jsx';
import SaveAdvert           from 'page/home/saveadvert.jsx'
    ...
    <Router history={hashHistory}>
        <Route path="/">
            ...
            <Route path="home" component={Layout}>
                ...
                <Route path="addadvert" component={SaveAdvert}/>
            </Route>
            {/* product */} 
            ...
            {/* sale */}
            <Route path="sale" component={Layout}>
                <IndexRedirect to="index"/>
                <Route path="index" component={SaleList}/>
                <Route path="income" component={IncomeTrend}/>
            </Route>
